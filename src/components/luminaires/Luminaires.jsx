...
import { row, columns, optionsComponents, typeIluminary, bodySend, dataForm, validationSchema } from "./luminaires.data";
...
export const Luminaires = () => {
    ...
    return (
        <div >
            <TableShared iconTitle={'light'} title={'Luminaria'} columns={columns} rows={rows} optionsComponents={optionsComponents} returnData={getDataTable}/>
